...
The Vehicle Risk tab reads `public/data/vehicle-risk-latest.json`, which is generated by:

```sh
npm run vehicle-risk:forecast
```

The forecast script builds a 72-hour theft-from-auto and stolen-vehicle place/time risk assessment using the Montgomery County Crime dataset, parking and transit context, calendar features, and National Weather Service hourly forecasts. It writes:

- `data/vehicle-risk/forecasts/YYYY-MM-DD.json`
- `data/vehicle-risk/assessments/YYYY-MM-DD.md`
